...
class RabbitMQ {
  ...
  publishCheckForAlmostExpiredOrganizations () {
    return this._rabbit.publishTask('organization.trial-almost-expired.check', {})
  }

  publishCheckForExpiredOrganizations () {
    return this._rabbit.publishTask('organization.trial-expired.check', {})
  }

  publishCheckForOrganizationPaymentHaveFailed () {
    return this._rabbit.publishTask('organization.payment-failed.check', {})
  }

  publishCheckForAlmostInactiveOrganizations () {
    return this._rabbit.publishTask('organization.almost-inactive.check', {})
  }
}

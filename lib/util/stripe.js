...
module.exports = class Stripe {
  ...
  static updateSubsriptionWithTrialEndedNotification (stripeSubscriptionId, notificationSentTime) {
    ...
    log.info('Stripe.updateSubsriptionWithTrialEndedNotification called')
    const updates = {
      metadata: {
  ...
  static updateSubsriptionWithTrialEndingNotification (stripeSubscriptionId, notificationSentTime) {
    const log = logger.child({ stripeSubscriptionId: stripeSubscriptionId, notificationSentTime: notificationSentTime }, 'Stripe.updateCustomerTrialEnded')
    log.info('Stripe.updateSubsriptionWithTrialEndingNotification called')
    const updates = {
      metadata: {

...
module.exports = class StripeSubscriptionUtils {
  ...
  static get (org) {
    ...
    return Promise.try(function () {
      if (!org.stripeCustomerId) {
        throw new ValidationError('Organization has no `stripeSubscriptionId`', { org })
      }
      return stripeClient.subscriptions.retrieve(org.stripeSubscriptionId)
    })
  }
  ...
  static updatePlanIdForOrganizationBasedOnCurrentUsage (org) {
    ...
    return Promise.all([
      StripeSubscriptionUtils.get(org),
  ...
  static updateUsersForPlan (org) {
    ...
    return StripeSubscriptionUtils.subscriptions.get(org)

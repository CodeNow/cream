...
module.exports = class StripeSubscriptionUtils {
   ...
   * @returns {Promise}
   */
  static createSubscription (stripeCustomerId, users, planId) {
    const log = logger.child({ stripeCustomerId: stripeCustomerId, users: users, planId: planId }, 'Stripe.createSubscription')
  ...
  static updatePlanIdForOrganizationBasedOnCurrentUsage (org) {
    ...
    return StripeSubscriptionUtils.getPlanIdForOrganizationBasedOnCurrentUsage(org.githubId)
      .then(function updateCustomerInStripe (planId) {
        log.trace({ org, planId }, 'Fetched planId')
  ...
  static updateWithTrialEndedNotification (stripeSubscriptionId, notificationSentTime) {
    const methodName = 'Stripe.subscriptions.updateCustomerTrialEnded'
    const log = logger.child({ stripeSubscriptionId: stripeSubscriptionId, notificationSentTime: notificationSentTime }, methodName)

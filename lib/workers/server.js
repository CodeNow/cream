...
const PaymentMethodAdded = require('./organization.payment-method.added.js')
...
const PayInvoice = require('./organization.invoice.pay')
...
module.exports = new ponos.Server({
  ...
  events: {
    ...
    // Payment method
    'organization.payment-method.added': PaymentMethodAdded,
  ...
  tasks: {
    ...
    'organization.invoice.pay': PayInvoice,
    // Status checks

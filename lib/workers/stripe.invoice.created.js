    ...
    .then(function fetchOrganization (stripeEvent) {
      ...
      return bigPoppa.getOrganizations({ stripeCustomerId: stripeCustomerId })
        ...
        .tap(function payInvoice () {
          ...
          let invoiceId = stripeEvent.data.object.id
          let invoiceHasBeenPaid = stripeEvent.data.object.paid
          log.trace({ invoiceHasBeenPaid, invoiceId }, 'Checking if invoice has not been paid')
